...
public class QuotationLineReader implements Closeable {
   ...
   * @throws IOException
   */
  public QuotationLineReader(InputStream in) {
   ...
   * @throws IOException
   */
  public QuotationLineReader(InputStream in, int bufferSize) {
    this.in = in;
   ...
   * @throws IOException
   */
  public QuotationLineReader(InputStream in, Configuration conf) throws IOException {
   ...
   */
  public QuotationLineReader(InputStream in, byte[] recordDelimiterBytes) {
    this.in = in;
   ...
   * @throws IOException
   */
  public QuotationLineReader(InputStream in, Configuration conf,
