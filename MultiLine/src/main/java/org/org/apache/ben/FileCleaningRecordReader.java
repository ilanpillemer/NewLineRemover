...
public class FileCleaningRecordReader extends RecordReader<LongWritable, Text> {
  ...
  private long pos;
  private long end;
  private QuotationLineReader in;
  ...
  public FileCleaningRecordReader() {
  }

  public FileCleaningRecordReader(byte[] recordDelimiter) {
  ...
  public void initialize(InputSplit genericSplit,
    ...
    if (null!=codec) {
      ...
      if (codec instanceof SplittableCompressionCodec) {
        ...
        if (null == this.recordDelimiterBytes) {
          in = new QuotationLineReader(codec.createInputStream(fileIn, decompressor),
              job);
        } else {
          in = new QuotationLineReader(codec.createInputStream(fileIn,
